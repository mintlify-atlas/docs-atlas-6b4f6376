---
title: "SFML Backend for Prowl.Quill: SFML.Net Vector Graphics"
sidebarTitle: "SFML"
description: "Integrate Prowl.Quill with SFML.Net. Covers NuGet setup, SFMLRenderer initialization, the per-frame loop, the shader pipeline, and backdrop blur."
---
