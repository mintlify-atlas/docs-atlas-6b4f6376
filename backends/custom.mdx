...
description: "Full guide to implementing ICanvasRenderer for any graphics API. Covers all four methods, the DrawCall model, Brush and Scissor uniforms, and a skeleton."
---
