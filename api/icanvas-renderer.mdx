...
description: "Full reference for the ICanvasRenderer interface: texture lifecycle, draw-call submission, scissor handling, backdrop blur support, and a minimal skeleton implementation."
---
